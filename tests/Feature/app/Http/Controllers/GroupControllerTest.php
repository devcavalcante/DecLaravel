...
class GroupControllerTest extends TestCase
{
    ...
    public function testShouldDelete()
    {
        ...
        $group = Group::factory(['type_group_id' => $typeGroup->id, 'representative_id' => $representative->id, 'creator_user_id' => $user->id])->create();
    ...
    private function fakePayload(): array
    {
        $typeUser = TypeUser::where('name', TypeUserEnum::MANAGER)->first();
        $typeGroup = TypeGroup::factory()->create();
        User::factory()->create(['type_user_id' => $typeUser->id]);
